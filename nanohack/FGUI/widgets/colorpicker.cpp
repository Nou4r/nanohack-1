...
namespace FGUI
{
  ...
  {
    m_dmSize = { 15, 15 }; // this is required to keep the widget from being padded on groupboxes
  ...
  void CColorPicker::Save(nlohmann::json& module)
  {
    ...
    module[strFormatedWidgetName][xorstr_("red")] = m_clrDefault.m_ucRed;
    module[strFormatedWidgetName][xorstr_("green")] = m_clrDefault.m_ucGreen;
    module[strFormatedWidgetName][xorstr_("blue")] = m_clrDefault.m_ucBlue;
    module[strFormatedWidgetName][xorstr_("alpha")] = m_clrDefault.m_ucAlpha;
  }
  ...
  void CColorPicker::Load(nlohmann::json& module)
  {
    ...
    {
      m_clrDefault.m_ucRed = module[strFormatedWidgetName][xorstr_("red")];
      m_clrDefault.m_ucGreen = module[strFormatedWidgetName][xorstr_("green")];
      m_clrDefault.m_ucBlue = module[strFormatedWidgetName][xorstr_("blue")];
      m_clrDefault.m_ucAlpha = module[strFormatedWidgetName][xorstr_("alpha")];
    }
  }
